...
public class BeatDetection : MonoBehaviour
{
	...
	private const float MIN_BEAT_SEPARATION = 0.50f;            //Minimum beat separation in time
	 ...
	 ********************************************
	 ...
	 It catches the type of beat detected.
	...
	********************************************/
	void Update()
	{
		...
		//TODO: This is test code I wrote. Ignore it for now, probably delete it later.
		//if (!GetComponent<AudioSource>().isPlaying)
		//{
		//	ArrayList beatMap = GameObject.Find("BeatDetectionEvent").GetComponent<EventExample>().beatMap;
		//	string songName = GetComponent<AudioSource>().clip.name;
		//	string fileName = "C:\\Users\\Hayden\\Documents\\Waifu Runner 3D\\Assets\\" + songName + ".txt";
