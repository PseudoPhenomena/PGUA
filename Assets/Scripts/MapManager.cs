...
public class MapManager : MonoBehaviour {
	...
	//Refrence to colbutton for starting colButtons array
	public GameObject button;

	//Button array
	private Button[] colButtons = new Button[4];
...
//		{
//			Debug.Log(kvPair.Key);
//			GameObject newItem = Instantiate(col, new Vector3(), Quaternion.identity) as GameObject;
			

//			//Column newCol = newItem.GetComponent<Column>();
//			newItem.GetComponent<Column>().pos = BeatMap[kvPair.Key].pos;
//			newItem.GetComponent<Column>().BeatNumber = BeatMap[kvPair.Key].BeatNumber;
//			newItem.GetComponent<Column>().colButtons = BeatMap[kvPair.Key].colButtons;
//			newItem.GetComponent<Column>().MM = this;
